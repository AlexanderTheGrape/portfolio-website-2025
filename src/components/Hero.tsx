...
const Hero = () => {
  return (
    <div className = "smol">
      <iframe src="https://drive.google.com/file/d/1jAqoJk2iY0C946U5yFbcb-kWDOkh7SB-/preview" width="960" height="540" allow="autoplay"></iframe>
    </div>
    // <div className="relative h-screen w-full overflow-hidden">
    //   {/* Video Background */}
    //   <div className="absolute inset-0 w-full h-full">
    //   <iframe src="https://drive.google.com/file/d/1DFcvwdxRXRvnExnvJWzwdgWUF6j5wFRz/preview" width="640" height="480" allow="autoplay"></iframe>
